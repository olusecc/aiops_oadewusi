...
y_min_gauge = Gauge('y_min', 'Lower bound of prediction')
y_gauge = Gauge('y', 'Actual value')
y_max_gauge = Gauge('y_max', 'Upper bound of prediction')

# Prometheus URL and query
...
def load_training_data():
    with open('boutique_train.json', 'r') as file:
        data = json.load(file)
